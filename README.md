...
## Current Update
2026-04-11: Lots of code cleanups, UI improvements and building dynamic variables fromt the database which are used during the export process. The hello world BASIC code is starting to work and export a running platform screen for Vic 20.  Other platforms will be done next.
