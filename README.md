...
## Current Update
2025-11-20: Memory maps and color lookups now in a database vs flat files and adding them to appear in the UI.  This will allow for easier exports and fewer hard coded entries.  Eventually this will allow for easier exports to other targets.
