...
## Current Update
2025-11-11: I am moving flat file config files for the platforms into the database and refactoring the code to obtain this information from that source.
