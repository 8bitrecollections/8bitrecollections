...
## Current Update
2025-12-06: Still removing the static tier levels based on my original proof of concept and building dynamic widgets.  Removing the flat file based widget values and moving them into a database.
