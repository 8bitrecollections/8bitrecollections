...
## Current Update
2025-12-09: Refactoring the new database design and hand editing the previous fields and corrected them.  Updating the UI.  Still several days to go.  Then comes debugging the previous code and updating it to work with the new design.  Merging in some Intellivision information I found and also ordered a book for that platform with information on game building.
