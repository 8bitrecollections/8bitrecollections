...
## Current Update
2025-11-13: Using color codes from the database now vs flat files and working out the logistics of more dynamic way to handle platform tiers.  This will allow me to easily build for more platforms.
