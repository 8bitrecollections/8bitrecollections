...
## Current Update
2025-11-23: Relearning GTK TreeViews and loading data into Glade.  Tab signals working, tab cleanups, data pulling nicely from Colors and MemoryMap database, and now getting it to load into the TreeView.
