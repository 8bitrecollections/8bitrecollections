...
## Current Update
2026-06-27:  Vic20, Commodore 64, Intellivision, Colecovision and TI994A are all exporting the game shell. I am now adding support for the Commodore Plus4 as a proof of concept on using the function to translate between systems of similar specs.  The Plus4 export is super close to working, just need to do some color modifications from C64 -> Plus4 and a few timer and joystick issues.   The next step will be to loop through the platforms and merge in the sprites.  After that, basic game play
