...
## Current Update
2025-12-28: The database has been reorganized and optimized for the new dynamic tier schema and validated with a new integrity script.  I am not refactoring the many changes in the code to handle the new schema.  Quite a lot of code needs to be changed to move away from the old POC design of hard platform tiers and moving to new dynamic tiers.  This will allow for multiple platforms to be built. 
