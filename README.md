...
## Current Update
2026-02-23: Petscii game editing is greatly improved, now dumping reverse characters and loading them into the UI.  The editor allows for selection of characters and inserts them into the design tool just like pixel editing. Bug cleanups related to support 2 and 4 color editing on Commodore platforms. Things are looking good.
