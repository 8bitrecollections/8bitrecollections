...
## Current Update
2025-12-19: Still refactoring the database into the new format and hand editing the fields.  Also cleaning up any typos and formatting the columns to be consistent.  Once that is done, I will write a utlity to check the data as part of normal building to ensure all fields are accurate and have proper values.  When this is complete, then code refactor to use the database and unhook the old flat file technique used for the POC.
