...
## Current Update
2026-05-09: Lots of progress in the last month.  The screen builder is mostly finished and now exporting screens into running games for Vic and Intellivision using INTYBASIC and Commodores built in BASIC for hello world.  This is the first step to exporting the whole game in working form.  Database changes allow for a tablet of contents that determine game flow.   Next up exporting hello world to C64 and TI 99/4A.   After that, sprite work and then initial export of the whole game.
