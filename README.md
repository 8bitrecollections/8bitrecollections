...
## Current Update
2026-06-15: Things are still moving along nicely.  I have Intellivision, TI99 and Colecovision all exporting into a running game shell.  I am now working on compiling in similar manner Vic20, C64 and Plus-4.  Once that is done, I will add in sprites next, and then start to add actual game and movement logic.  The hardest parts are done, variables are all exporting.  Now it's just a matter of platform optimizations.
