...
## Current Update
2026-01-28: Continue cleaning up the code and database.  Merged in TI 99 and Intellivision color codes and configured UI editor to allow for both 2 and 4 color editing.  This will work on Commodore platform as well to allow for single color sprites and images.  Starting to develop a much better approach to export the screens and graphics to export to BASIC than the POC.  Platforms with built in BASIC will export code that builds a screen that shows the design, but of course will be too slow to run.  Intellivision I think will just export right into IntyBASIC and be ready to compile.
