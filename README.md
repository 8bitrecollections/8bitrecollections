...
## Current Update
2026-02-20: Getting closer and closer to all features being in the software. Vic 20 Petscii is finished and working, and now merging in Commodore 64 Petscii support.  At that point I will be bug hunting and connecting a few of the UI buttons that are not working.  I also am tinkering with an idea for a floating platform assistant that will help make decisions about graphics and colors.  After that, I will be back on exporting BASIC on all platforms.
